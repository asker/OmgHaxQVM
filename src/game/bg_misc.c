...
classAttributes_t bg_classList[ ] =
{
  ...
  },
  {
    ...
    SCA_TAKESFALLDAMAGE|SCA_FOVWARPS|SCA_WALLJUMPER|SCA_ALIENSENSE,//int     abilities;
  ...
  },
  {
    ...
    SCA_FOVWARPS|SCA_WALLCLIMBER|SCA_WALLJUMPER|SCA_ALIENSENSE,    //int     abilities;
